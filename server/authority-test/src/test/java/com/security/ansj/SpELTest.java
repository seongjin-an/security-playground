...
public class SpELTest {
    ...
    @Test
    void test_2(){
        parser.parseExpression("name").setValue(person, "anseongjin");
        assertEquals("anseongjin", parser.parseExpression("name").getValue(person));
    }
    ...
    void test_4(){
        ...
        ctx.setVariable("horse2", nancy);
        assertFalse(parser.parseExpression("#horse2.over(170)").getValue(ctx, Boolean.class));
    }
}
