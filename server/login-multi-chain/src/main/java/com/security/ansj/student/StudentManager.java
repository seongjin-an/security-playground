...
//        );
        new HashSet<Student>(Arrays.asList(
                new Student("hong", "홍길동", new HashSet(Arrays.asList(new SimpleGrantedAuthority("ROLE_STUDENT"))), "choi"),
                new Student("kang", "강아지", new HashSet(Arrays.asList(new SimpleGrantedAuthority("ROLE_STUDENT"))), "choi"),
                new Student("rang", "호랑이", new HashSet(Arrays.asList(new SimpleGrantedAuthority("ROLE_STUDENT"))), "choi")
